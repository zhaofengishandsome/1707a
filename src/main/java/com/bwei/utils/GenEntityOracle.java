...
public class GenEntityOracle {
    ...
    private String packageOutPath = "com.bwei.entity";// 指定实体生成所在包的路径
...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/cms_01?user=root&password=root&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityOracle("brand","Brand","cms_01").init();  
        new GenEntityOracle("goods","Goods","cms_01").init();  
        new GenEntityOracle("goodskind","GoodsKind","cms_01").init();  
    }  
}